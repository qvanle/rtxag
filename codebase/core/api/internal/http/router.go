...
func NewRouter(deps handlers.Deps) http.Handler {
	...
	r.Route("/api/admin", func(r chi.Router) {
		...
		r.Get("/tools/collections", h.ListToolCollections)
		r.Post("/tools/collections", h.CreateToolCollection)
		r.Get("/tools/collections/{collection_id}", h.GetToolCollection)
		r.Patch("/tools/collections/{collection_id}", h.UpdateToolCollection)
		r.Delete("/tools/collections/{collection_id}", h.DeleteToolCollection)
		r.Get("/tools/collections/{collection_id}/records", h.ListToolRecords)
		r.Post("/tools/collections/{collection_id}/records", h.CreateToolRecord)
		r.Patch("/tools/collections/{collection_id}/records/{record_id}", h.UpdateToolRecord)
		r.Delete("/tools/collections/{collection_id}/records/{record_id}", h.DeleteToolRecord)
